...
//       <div className="w-full max-w-md bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-8 relative z-10 animate-slideIn border border-white/20">
//         <div className="text-center mb-8 animate-float">
//           <div className="inline-block p-4 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full mb-4 animate-glow">
//             <svg
...
//               placeholder="John Doe"
//               className="w-full px-4 py-3 rounded-xl border-2 border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 focus:outline-none focus:border-indigo-500 transition-all duration-300 input-glow"
//               disabled={loading}
//             />
//           </div>
...
//             disabled={loading}
//             className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed btn-glow shadow-lg"
//           >
//             {loading ? (
...
//     try {
//       setLoading(true); // Disable button during registration process
//       const result = await register(email, password);
//       console.log(result);
...
//   const handleGoogleSignUp = async () => {
//     try {
//       setLoading(true); // Disable button during Google login
//       await loginWithGoogle();
...
//     <>
//       <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 px-4 py-8 relative overflow-hidden">
//         {/* Your styled container and form */}
//         <div className="w-full max-w-md bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl shadow-2xl p-8 relative z-10 register-animate-slideIn">
//           <div className="text-center mb-8 register-animate-float">
//             <h2 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-2">
//               Create Account
//             </h2>
...
//                 onKeyPress={handleKeyPress}
//                 placeholder="John Doe"
//                 className="w-full px-4 py-3 rounded-xl border-2 border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 focus:outline-none focus:border-indigo-500"
//                 disabled={loading}
//               />
//             </div>
...
//               onClick={handleSubmit}
//               disabled={loading}
//               className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
//             >
//               {loading ? (
//                 <span className="flex items-center justify-center gap-2">
//                   <svg className="animate-spin h-5 w-5" viewBox="0 0 24 24">
